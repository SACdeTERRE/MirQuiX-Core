Contributing to mqx Core
============================

The mqx Core project operates an open contributor model where anyone is
...
The following applies to code changes to the mqx Core project, and is not to be
confused with overall mqx Network Protocol consensus changes.

Whether a pull request is merged into mqx Core rests with the project merge
...
Patches that change mqx consensus rules are considerably more involved than
...
Where a patch set proposes to change the mqx consensus, it must have been
...
The project leader is the release manager for each mqx Core release.
