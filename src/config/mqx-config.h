/* src/config/mqx-config.h.  Generated from mqx-config.h.in by configure.  */
/* src/config/mqx-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.mqx.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "mqx Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "mqx Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "mqx"
