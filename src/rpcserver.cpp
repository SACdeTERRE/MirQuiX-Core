...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* mqx features */
        {"mqx", "masternode", &masternode, true, true, false},
        {"mqx", "listmasternodes", &listmasternodes, true, true, false},
        {"mqx", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mqx", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mqx", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mqx", "masternodedebug", &masternodedebug, true, true, false},
        {"mqx", "startmasternode", &startmasternode, true, true, false},
        {"mqx", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mqx", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mqx", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mqx", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mqx", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mqx", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mqx", "mnbudget", &mnbudget, true, true, false},
        {"mqx", "preparebudget", &preparebudget, true, true, false},
        {"mqx", "submitbudget", &submitbudget, true, true, false},
        {"mqx", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mqx", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mqx", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mqx", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mqx", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mqx", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mqx", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mqx", "checkbudgets", &checkbudgets, true, true, false},
        {"mqx", "mnsync", &mnsync, true, true, false},
        {"mqx", "spork", &spork, true, true, false},
        {"mqx", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"mqx", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use mqxd, or the -server option to mqx-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> mqx-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:58883/\n";
}
