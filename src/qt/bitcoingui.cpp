                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("mqx Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a mqx address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mqx: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zmqx"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About mqx Core"), this);
    aboutAction->setStatusTip(tr("Show information about mqx Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for mqx"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your mqx addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified mqx addresses"));
    ...
    openAction->setStatusTip(tr("Open a mqx: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the mqx Core help message to get a list with possible mqx command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("mqx Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to mqx network", "", count));
}
...
{
    QString strTitle = tr("mqx Core"); // default title
...
/** Creates context menu, its actions, and mqxs up all the relevant signals for mouse events. */
