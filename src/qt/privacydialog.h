...
public:
    ...
    void setZmqxControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzmqx_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzmqx_clicked();
    void on_pushButtonZmqxControl_clicked();
