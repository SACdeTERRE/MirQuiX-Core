...
RESOURCES += src/qt/mqx.qrc src/qt/mqx_locale.qrc

TRANSLATIONS += src/qt/locale/mqx_bg.ts \
                src/qt/locale/mqx_de.ts \
                src/qt/locale/mqx_en.ts \
                src/qt/locale/mqx_es.ts \
                src/qt/locale/mqx_fi.ts \
                src/qt/locale/mqx_fr.ts \
                src/qt/locale/mqx_it.ts \
                src/qt/locale/mqx_ja.ts \
                src/qt/locale/mqx_pl.ts \
                src/qt/locale/mqx_pt.ts \
                src/qt/locale/mqx_ru.ts \
                src/qt/locale/mqx_sk.ts \
                src/qt/locale/mqx_sv.ts \
                src/qt/locale/mqx_vi.ts \
                src/qt/locale/mqx_zh_CN.ts \
                src/qt/locale/mqx_zh_TW.ts
