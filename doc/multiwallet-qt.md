...
In order to support loading of multiple wallets in mqx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mqx.cpp.
...
Changes to mqx.cpp
----------------------
mqx.cpp is the entry point into mqx-qt, and as such, will require some minor modifications to provide hooks for
